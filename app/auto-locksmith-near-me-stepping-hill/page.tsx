...
const location = "Stepping Hill"
const locationSlug = "stepping-hill"
const neighborhoods = ["Stepping Hill","Hazel Grove","Offerton","Woodsmoor"]

export const metadata: Metadata = {
  title: "Stepping Hill Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Stepping Hill? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Stepping Hill auto locksmith",
    "auto locksmith near me Stepping Hill",
    "emergency locksmith Stepping Hill",
    "car key replacement Stepping Hill",
    "key fob programming Stepping Hill",
    "lost car keys Stepping Hill",
    "24/7 auto locksmith Stepping Hill",
    "mobile locksmith Stepping Hill",
    "emergency car lockout Stepping Hill",
    "smart key programming Stepping Hill",
  ],
