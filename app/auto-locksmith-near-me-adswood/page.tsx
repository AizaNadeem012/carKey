...
const location = "Adswood"
const locationSlug = "adswood"
const neighborhoods = ["Adswood","Brinnington","Portwood","Edgeley"]

export const metadata: Metadata = {
  title: "Adswood Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Adswood? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Adswood auto locksmith",
    "auto locksmith near me Adswood",
    "emergency locksmith Adswood",
    "car key replacement Adswood",
    "key fob programming Adswood",
    "lost car keys Adswood",
    "24/7 auto locksmith Adswood",
    "mobile locksmith Adswood",
    "emergency car lockout Adswood",
    "smart key programming Adswood",
  ],
