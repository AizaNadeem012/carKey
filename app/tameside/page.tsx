...
const location = "Tameside"
const locationSlug = "tameside"
const neighborhoods = ["Ashton-under-Lyne","Denton","Dukinfield","Hyde"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Tameside Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Tameside. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Tameside auto locksmith",
    "auto locksmith near me Tameside",
    "Tameside car key replacement",
    "Tameside emergency locksmith",
    "lost car keys Tameside",
    "key fob programming Tameside",
    "24/7 locksmith Tameside",
    "mobile locksmith Tameside",
    "emergency car lockout Tameside",
    "smart key programming Tameside",
    "transponder key Tameside",
    "ignition repair Tameside",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Tameside Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Tameside. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Tameside",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-tameside.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Tameside",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Tameside Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Tameside. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-tameside.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-tameside.jpg",
