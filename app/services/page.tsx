  ...
  const services = [
    {
      ...
      price: "From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89",
    ...
    },
    {
      ...
      price: "From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£79",
    ...
    },
    {
      ...
      price: "From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£59",
    ...
    },
    {
      ...
      price: "From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£99",
      image: "/real-locksmith-service.jpg",
    },
    {
      ...
      price: "From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£69",
      image: "/real-car-keys.jpg",
    },
    {
            ...
            <table className="w-full bg-slate-700 rounded-2xl overflow-hidden">
              ...
              <tbody className="divide-y divide-slate-600">
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£129</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£199</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£79</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£99</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£149</td>
                  <td className="px-6 py-4 text-center text-gray-300">30 mins</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 font-semibold text-gray-300">Lockout Service</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£59</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£79</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£99</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£99</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£149</td>
                  <td className="px-6 py-4 text-center text-orange-400">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£249</td>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£2M insurance covers any potential damage during service.",
              },
              {
