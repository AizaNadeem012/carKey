...
export const metadata: Metadata = {
  title: "Van Lockout Assistance Stockport | Emergency Mobile Service 24/7 | From ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£69",
  description:
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="card">
                  ...
                  <div className="text-sm font-semibold">From ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£69</div>
                </div>
              </div>
            </div>
              ...
              <div className="card p-6">
                ...
                <ul className="space-y-3 text-sm text-gray-300">
                  <li className="flex justify-between">
                    ...
                    <span className="text-orange-400 font-bold">From ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£69</span>
                  </li>
                  <li className="flex justify-between">
