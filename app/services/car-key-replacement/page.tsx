...
export const metadata: Metadata = {
  title: "Car Key Replacement Stockport | Cut & Programmed On-Site | From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89 | 25 Min Response",
  description:
  ...
  openGraph: {
    ...
    description: "Lost your car key? We cut and program new keys on-site. From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89. 25-min response. Call 07309903243",
  ...
  const faqItems = [
    {
      ...
      answer: "Car key replacement starts from ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89 depending on your vehicle type and key complexity. We provide transparent pricing upfront with no hidden fees.",
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                ...
                service across Stockport. Cut and programmed on-site from ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£89.
              </p>
              ...
              <div className="card">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-orange-400 font-bold">From ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£199</span>
                  </div>
                </div>
