...
const locationSlug = "bramhall"
const neighborhoods = ["Bramhall","Bramhall Park","Woodsmoor","Hazel Grove"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Bramhall Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Bramhall. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Bramhall auto locksmith",
    "auto locksmith near me Bramhall",
    "Bramhall car key replacement",
    "Bramhall emergency locksmith",
    "lost car keys Bramhall",
    "key fob programming Bramhall",
    "24/7 locksmith Bramhall",
    "mobile locksmith Bramhall",
    "emergency car lockout Bramhall",
    "smart key programming Bramhall",
    "transponder key Bramhall",
    "ignition repair Bramhall",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Bramhall Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Bramhall. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Bramhall",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-bramhall.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Bramhall",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Bramhall Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Bramhall. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-bramhall.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-bramhall.jpg",
