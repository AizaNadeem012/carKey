...
const location = "Trafford"
const locationSlug = "trafford"
const neighborhoods = ["Sale","Altrincham","Stretford","Urmston"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Trafford Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Trafford. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Trafford auto locksmith",
    "auto locksmith near me Trafford",
    "Trafford car key replacement",
    "Trafford emergency locksmith",
    "lost car keys Trafford",
    "key fob programming Trafford",
    "24/7 locksmith Trafford",
    "mobile locksmith Trafford",
    "emergency car lockout Trafford",
    "smart key programming Trafford",
    "transponder key Trafford",
    "ignition repair Trafford",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Trafford Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Trafford. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Trafford",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-trafford.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Trafford",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Trafford Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Trafford. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-trafford.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-trafford.jpg",
