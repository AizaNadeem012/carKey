...
const location = "Edgeley"
const locationSlug = "edgeley"
const neighborhoods = ["Edgeley","Davenport","Offerton","Portwood"]

export const metadata: Metadata = {
  title: "Edgeley Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Edgeley? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Edgeley auto locksmith",
    "auto locksmith near me Edgeley",
    "emergency locksmith Edgeley",
    "car key replacement Edgeley",
    "key fob programming Edgeley",
    "lost car keys Edgeley",
    "24/7 auto locksmith Edgeley",
    "mobile locksmith Edgeley",
    "emergency car lockout Edgeley",
    "smart key programming Edgeley",
  ],
