...
export default function AboutPage() {
  return (
    <main className="bg-slate-900 text-white pt-20">
      ...
      {/* Vikki Heaton â€” Verified Author & Business Owner */}
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-shrink-0 flex flex-col items-center gap-3">
              <Image
                ...
                alt="Vikki Heaton â€” Auto Locksmith & Business Owner, Stockport"
                width={160}
                height={180}
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
                Vikki Heaton â€” Auto Locksmith &amp; Business Owner
              </h2>
              <p className="text-gray-300 leading-relaxed mb-4">
                Hi, I&apos;m Vikki â€” and I personally attend every job. I founded Car Keys Stockport in 2016
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                ...
                Stockport and Greater Manchester 24 hours a day, 7 days a week â€” including bank holidays.
              </p>
            ...
            {[
              ...
              <div key={index} className="card text-center">
                ...
                <p className="text-gray-300 text-sm mb-3">
                  {member.experience} â€¢ {member.speciality}
                </p>
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Fully insured with Â£2 million public liability coverage for complete customer protection and peace of mind during our service.",
                  },
                  {
                    title: "DBS Checked",
                    description:
      ...
      <section className="section-padding bg-slate-800">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              When you choose Car Keys Stockport, you're not just getting a locksmith â€“ you're getting a partner
