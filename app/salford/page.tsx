...
const location = "Salford"
const locationSlug = "salford"
const neighborhoods = ["Salford","Eccles","Swinton","Walkden"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Salford Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Salford. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Salford auto locksmith",
    "auto locksmith near me Salford",
    "Salford car key replacement",
    "Salford emergency locksmith",
    "lost car keys Salford",
    "key fob programming Salford",
    "24/7 locksmith Salford",
    "mobile locksmith Salford",
    "emergency car lockout Salford",
    "smart key programming Salford",
    "transponder key Salford",
    "ignition repair Salford",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Salford Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Salford. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Salford",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-salford.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Salford",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Salford Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Salford. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-salford.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-salford.jpg",
