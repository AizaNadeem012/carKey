...
const location = "Cheadle"
const locationSlug = "cheadle"
const neighborhoods = ["Cheadle","Cheadle Hulme","Gatley","Heald Green"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Cheadle Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Cheadle. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Cheadle auto locksmith",
    "auto locksmith near me Cheadle",
    "Cheadle car key replacement",
    "Cheadle emergency locksmith",
    "lost car keys Cheadle",
    "key fob programming Cheadle",
    "24/7 locksmith Cheadle",
    "mobile locksmith Cheadle",
    "emergency car lockout Cheadle",
    "smart key programming Cheadle",
    "transponder key Cheadle",
    "ignition repair Cheadle",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Cheadle Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Cheadle. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Cheadle",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-cheadle.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Cheadle",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Cheadle Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Cheadle. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-cheadle.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-cheadle.jpg",
