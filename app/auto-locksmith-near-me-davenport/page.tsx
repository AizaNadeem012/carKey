...
const location = "Davenport"
const locationSlug = "davenport"
const neighborhoods = ["Davenport","Davenport Park","Edgeley","Offerton"]

export const metadata: Metadata = {
  title: "Davenport Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Davenport? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Davenport auto locksmith",
    "auto locksmith near me Davenport",
    "emergency locksmith Davenport",
    "car key replacement Davenport",
    "key fob programming Davenport",
    "lost car keys Davenport",
    "24/7 auto locksmith Davenport",
    "mobile locksmith Davenport",
    "emergency car lockout Davenport",
    "smart key programming Davenport",
  ],
