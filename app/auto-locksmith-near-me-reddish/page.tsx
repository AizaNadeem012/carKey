...
const location = "Reddish"
const locationSlug = "reddish"
const neighborhoods = ["Reddish","North Reddish","South Reddish","Heaton Norris"]

export const metadata: Metadata = {
  title: "Reddish Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Reddish? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Reddish auto locksmith",
    "auto locksmith near me Reddish",
    "emergency locksmith Reddish",
    "car key replacement Reddish",
    "key fob programming Reddish",
    "lost car keys Reddish",
    "24/7 auto locksmith Reddish",
    "mobile locksmith Reddish",
    "emergency car lockout Reddish",
    "smart key programming Reddish",
  ],
