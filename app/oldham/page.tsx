...
const location = "Oldham"
const locationSlug = "oldham"
const neighborhoods = ["Oldham","Chadderton","Royton","Shaw"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Oldham Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Oldham. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Oldham auto locksmith",
    "auto locksmith near me Oldham",
    "Oldham car key replacement",
    "Oldham emergency locksmith",
    "lost car keys Oldham",
    "key fob programming Oldham",
    "24/7 locksmith Oldham",
    "mobile locksmith Oldham",
    "emergency car lockout Oldham",
    "smart key programming Oldham",
    "transponder key Oldham",
    "ignition repair Oldham",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Oldham Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Oldham. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Oldham",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-oldham.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Oldham",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Oldham Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Oldham. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-oldham.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-oldham.jpg",
