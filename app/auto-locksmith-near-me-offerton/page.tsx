...
const location = "Offerton"
const locationSlug = "offerton"
const neighborhoods = ["Offerton","Edgeley","Davenport","Hazel Grove"]

export const metadata: Metadata = {
  title: "Offerton Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Offerton? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Offerton auto locksmith",
    "auto locksmith near me Offerton",
    "emergency locksmith Offerton",
    "car key replacement Offerton",
    "key fob programming Offerton",
    "lost car keys Offerton",
    "24/7 auto locksmith Offerton",
    "mobile locksmith Offerton",
    "emergency car lockout Offerton",
    "smart key programming Offerton",
  ],
