...
const location = "Bredbury"
const locationSlug = "bredbury"
const neighborhoods = ["Bredbury","Romiley","Woodley","Hyde"]

export const metadata: Metadata = {
  title: "Bredbury Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Bredbury? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Bredbury auto locksmith",
    "auto locksmith near me Bredbury",
    "emergency locksmith Bredbury",
    "car key replacement Bredbury",
    "key fob programming Bredbury",
    "lost car keys Bredbury",
    "24/7 auto locksmith Bredbury",
    "mobile locksmith Bredbury",
    "emergency car lockout Bredbury",
    "smart key programming Bredbury",
  ],
