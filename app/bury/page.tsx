...
const location = "Bury"
const locationSlug = "bury"
const neighborhoods = ["Bury","Radcliffe","Whitefield","Prestwich"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Bury Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Bury. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Bury auto locksmith",
    "auto locksmith near me Bury",
    "Bury car key replacement",
    "Bury emergency locksmith",
    "lost car keys Bury",
    "key fob programming Bury",
    "24/7 locksmith Bury",
    "mobile locksmith Bury",
    "emergency car lockout Bury",
    "smart key programming Bury",
    "transponder key Bury",
    "ignition repair Bury",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Bury Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Bury. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Bury",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-bury.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Bury",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Bury Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Bury. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-bury.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-bury.jpg",
