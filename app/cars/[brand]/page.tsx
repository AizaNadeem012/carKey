            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                  ...
                  wherever you are in {location}ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âhome, work, or roadside. Your trusted local auto locksmith service.
                </p>
              ...
              <ul className="space-y-4 text-lg">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">
                    ...
                    chargesÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âyou know exactly what you'll pay upfront before any work begins
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                  <span className="text-gray-300">
                    <strong className="text-white">Mobile Service:</strong> We come to youÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âhome, work, or roadside in{" "}
        ...
        <section className="section-padding bg-red-600">
          <div className="container-custom text-center">
            ...
            <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              you need it most. Our mobile service means we come to youÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âwhether you're at home, work, or stranded
            ...
            <p className="text-sm opacity-90">Available 24/7 ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Fast Response ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ No Call-Out Fee ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Fully Insured</p>
          </div>
        </section>
        ...
        <section className="section-padding bg-gradient-to-r from-orange-600 to-red-600">
          <div className="container-custom text-center">
            ...
            <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
              ...
              insuredÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Âyour trusted local auto locksmith in {location}.
            </p>
            ...
            <div className="max-w-2xl mx-auto bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              <p className="text-lg mb-4">
                <strong>Fully Insured</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ <strong>No Call-Out Fee</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ <strong>Fast Response</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢{" "}
