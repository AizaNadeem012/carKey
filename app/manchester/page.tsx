...
const neighborhoods = ["Manchester City Centre","Salford","Trafford","Didsbury"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Manchester Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Manchester. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Manchester auto locksmith",
    "auto locksmith near me Manchester",
    "Manchester car key replacement",
    "Manchester emergency locksmith",
    ...
    "smart key programming Manchester",
    "transponder key Manchester",
  ...
  openGraph: {
    title: "Manchester Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Manchester. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Manchester",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-manchester.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Manchester",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Manchester Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Manchester. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-manchester.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-manchester.jpg",
