...
const location = "Gatley"
const locationSlug = "gatley"
const neighborhoods = ["Gatley","Cheadle","Cheadle Hulme","Heald Green"]

export const metadata: Metadata = {
  title: "Gatley Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Gatley? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Gatley auto locksmith",
    "auto locksmith near me Gatley",
    "emergency locksmith Gatley",
    "car key replacement Gatley",
    "key fob programming Gatley",
    "lost car keys Gatley",
    "24/7 auto locksmith Gatley",
    "mobile locksmith Gatley",
    "emergency car lockout Gatley",
    "smart key programming Gatley",
  ],
