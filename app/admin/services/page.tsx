    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-border/50">
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-tight flex items-center gap-3">
            <span className="p-2 bg-primary/10 rounded-lg">Ã°Å¸â€ºÂ Ã¯Â¸Â</span>
            Services
          </h1>
          ...
          <DialogContent className="bg-card border-border max-w-md">
            <DialogHeader>
              <DialogTitle className="text-foreground flex items-center gap-2">
                <span className="text-xl">{editingService ? "Ã¢Å“ÂÃ¯Â¸Â" : "Ã¢Å¾â€¢"}</span>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Price (Ã‚Â£)</label>
              ...
              <Button onClick={handleSave} className="w-full bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 text-white shadow-lg hover:shadow-xl transition-all duration-300">
                {editingService ? "Ã¢Å“â€œ Update Service" : "Ã¢Å¾â€¢ Create Service"}
              </Button>
            </div>
          </DialogContent>
        </Dialog>
      ...
      <div className="flex flex-col sm:flex-row gap-3 bg-muted/30 p-4 rounded-lg border border-border/50">
        <div className="relative flex-1">
          ...
          <Input placeholder="Ã°Å¸â€Â Search services..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 bg-background/50 border-border focus:border-primary/50 focus:ring-primary/20" />
        </div>
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Badge variant={service.status === "active" ? "default" : "secondary"} className={`${
                    ...
                    {service.status === "active" ? "Ã¢Å“â€œ Active" : "Ã¢â€”â€¹ Inactive"}
                  </Badge>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/50">
                  <div className="flex items-center gap-2">
                    <div className="p-2 bg-primary/10 rounded-lg">
                      <span className="text-lg font-bold text-primary">Ã‚Â£{service.price.toLocaleString()}</span>
                    </div>
                  </div>
