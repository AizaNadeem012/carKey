    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-border/50">
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-tight flex items-center gap-3">
            <span className="p-2 bg-primary/10 rounded-lg">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂºÃƒâ€šÃ‚Â ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â</span>
            Services
          </h1>
          ...
          <DialogContent className="bg-card border-border max-w-md">
            <DialogHeader>
              <DialogTitle className="text-foreground flex items-center gap-2">
                <span className="text-xl">{editingService ? "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“Ãƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â" : "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¾ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"}</span>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Price (ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£)</label>
              ...
              <Button onClick={handleSave} className="w-full bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 text-white shadow-lg hover:shadow-xl transition-all duration-300">
                {editingService ? "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Update Service" : "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¾ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Create Service"}
              </Button>
            </div>
          </DialogContent>
        </Dialog>
      ...
      <div className="flex flex-col sm:flex-row gap-3 bg-muted/30 p-4 rounded-lg border border-border/50">
        <div className="relative flex-1">
          ...
          <Input placeholder="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Search services..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 bg-background/50 border-border focus:border-primary/50 focus:ring-primary/20" />
        </div>
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Badge variant={service.status === "active" ? "default" : "secondary"} className={`${
                    ...
                    {service.status === "active" ? "ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Active" : "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ÂÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹ Inactive"}
                  </Badge>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/50">
                  <div className="flex items-center gap-2">
                    <div className="p-2 bg-primary/10 rounded-lg">
                      <span className="text-lg font-bold text-primary">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£{service.price.toLocaleString()}</span>
                    </div>
                  </div>
