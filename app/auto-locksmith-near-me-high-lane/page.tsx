...
const location = "High Lane"
const locationSlug = "high-lane"
const neighborhoods = ["High Lane","Marple","Marple Bridge","Compstall"]

export const metadata: Metadata = {
  title: "High Lane Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in High Lane? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "High Lane auto locksmith",
    "auto locksmith near me High Lane",
    "emergency locksmith High Lane",
    "car key replacement High Lane",
    "key fob programming High Lane",
    "lost car keys High Lane",
    "24/7 auto locksmith High Lane",
    "mobile locksmith High Lane",
    "emergency car lockout High Lane",
    "smart key programming High Lane",
  ],
