            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
                  {location} Auto Locksmith Near Me 24/7 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Fast, Mobile Car Key Services
                </h1>
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                  ...
                  you wherever you are in {location}ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âhome, work, or roadside. Your trusted local auto locksmith
                  service.
                </p>
              ...
              <ul className="space-y-4 text-lg">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">
                    ...
                    chargesÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âyou know exactly what you'll pay upfront
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
        ...
        <section className="section-padding bg-red-600">
          <div className="container-custom text-center">
            ...
            <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              when you need it most. Our mobile service means we come to youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âwhether you're at home, work, or stranded
