...
const location = "Romiley"
const locationSlug = "romiley"
const neighborhoods = ["Romiley","Bredbury","Woodley","Hyde"]

export const metadata: Metadata = {
  title: "Romiley Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Romiley? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Romiley auto locksmith",
    "auto locksmith near me Romiley",
    "emergency locksmith Romiley",
    "car key replacement Romiley",
    "key fob programming Romiley",
    "lost car keys Romiley",
    "24/7 auto locksmith Romiley",
    "mobile locksmith Romiley",
    "emergency car lockout Romiley",
    "smart key programming Romiley",
  ],
