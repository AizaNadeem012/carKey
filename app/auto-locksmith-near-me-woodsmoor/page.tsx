...
const location = "Woodsmoor"
const locationSlug = "woodsmoor"
const neighborhoods = ["Woodsmoor","Bramhall","Hazel Grove","Offerton"]

export const metadata: Metadata = {
  title: "Woodsmoor Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Woodsmoor? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Woodsmoor auto locksmith",
    "auto locksmith near me Woodsmoor",
    "emergency locksmith Woodsmoor",
    "car key replacement Woodsmoor",
    "key fob programming Woodsmoor",
    "lost car keys Woodsmoor",
    "24/7 auto locksmith Woodsmoor",
    "mobile locksmith Woodsmoor",
    "emergency car lockout Woodsmoor",
    "smart key programming Woodsmoor",
  ],
