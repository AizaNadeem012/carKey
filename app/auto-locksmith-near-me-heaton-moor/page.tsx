...
const location = "Heaton Moor"
const locationSlug = "heaton-moor"
const neighborhoods = ["Heaton Moor","Heaton Mersey","Heaton Chapel","Heaton Norris"]

export const metadata: Metadata = {
  title: "Heaton Moor Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Heaton Moor? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Heaton Moor auto locksmith",
    "auto locksmith near me Heaton Moor",
    "emergency locksmith Heaton Moor",
    "car key replacement Heaton Moor",
    "key fob programming Heaton Moor",
    "lost car keys Heaton Moor",
    "24/7 auto locksmith Heaton Moor",
    "mobile locksmith Heaton Moor",
    "emergency car lockout Heaton Moor",
    "smart key programming Heaton Moor",
  ],
