...
const location = "Portwood"
const locationSlug = "portwood"
const neighborhoods = ["Portwood","Adswood","Brinnington","Edgeley"]

export const metadata: Metadata = {
  title: "Portwood Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Portwood? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Portwood auto locksmith",
    "auto locksmith near me Portwood",
    "emergency locksmith Portwood",
    "car key replacement Portwood",
    "key fob programming Portwood",
    "lost car keys Portwood",
    "24/7 auto locksmith Portwood",
    "mobile locksmith Portwood",
    "emergency car lockout Portwood",
    "smart key programming Portwood",
  ],
