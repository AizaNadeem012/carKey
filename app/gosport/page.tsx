...
const location = "Gosport"
const locationSlug = "gosport"
const neighborhoods = ["Gosport Town Centre","Lee-on-the-Solent","Fareham","Stubbington"]
const region = "Hampshire"

export const metadata: Metadata = {
  title: "Gosport Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Gosport. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Gosport auto locksmith",
    "auto locksmith near me Gosport",
    "Gosport car key replacement",
    "Gosport emergency locksmith",
    "lost car keys Gosport",
    "key fob programming Gosport",
    "24/7 locksmith Gosport",
    "mobile locksmith Gosport",
    "emergency car lockout Gosport",
  ...
  openGraph: {
    title: "Gosport Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Gosport. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Gosport",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-gosport.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Gosport",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Gosport Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Gosport. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-gosport.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-gosport.jpg",
...
export default function GosportPage() {
  return (
    <>
      <Script
