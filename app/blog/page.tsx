      ...
      <main className="max-w-5xl mx-auto p-6">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Ignition Repair & Replacement:</strong> Avoid expensive towing Ã¢â‚¬â€œ we fix ignition issues on-site.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li><strong>Fast Response:</strong> Mobile service across Stockport Ã¢â‚¬â€œ we come to you.</li>
