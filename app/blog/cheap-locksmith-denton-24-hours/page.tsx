    ...
    <>
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Cheap Locksmith Denton 24 Hours â€” Auto, Car & Van Services",
            description:
      ...
      <main className="max-w-5xl mx-auto p-6">
        ...
        <h1 className="text-4xl font-bold mb-4">
          Cheap Locksmith Denton 24 Hours â€” Auto, Car &amp; Van Services
        </h1>

        {/* Author block â€” E-E-A-T */}
        <div className="flex items-center gap-3 mb-6 pb-6 border-b border-gray-200">
          <Image
            src="/images/vikki-heaton-auto-locksmith-stockport.jpg"
            alt="Vikki Heaton â€” Auto Locksmith"
            width={48}
            height={48}
        ...
        <section className="mb-8">
          <p className="text-lg leading-relaxed">
            ...
            mobile auto, car and van locksmith service available day and night â€” including weekends and bank
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-4">
            ...
            Denton SK14 â€” ever. Before we start any work, you receive a fixed price quote by phone.
          </p>
          <p className="leading-relaxed mb-4">
            ...
            . Whatever your situation, we promise a cheap locksmith price for Denton â€” competitive, honest, and
            agreed upfront.
          </p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
            Car Locksmith vs Van Locksmith in Denton â€” What&apos;s the Difference?
          </h2>
          <p className="leading-relaxed mb-4">
          ...
          <p className="leading-relaxed mb-4">
            ...
            commercial vans, light goods vehicles, and all makes â€” Ford Transit, Mercedes Sprinter, Vauxhall
            Vivaro and more.{" "}
        ...
        {/* CTA box â€” placed after second H2 */}
        <section className="mb-8 rounded-lg border border-orange-400 bg-orange-50 p-6">
          ...
          <p className="mb-4">
            Call <strong>07309903243</strong> â€” available 24/7 in Denton SK14. 20 minute response. No
            call-out fee.
          </p>
          <Link
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 leading-relaxed mb-4">
            <li>
              <strong>Always ask for a fixed price upfront</strong> â€” before anyone touches your vehicle. A
              reputable cheap locksmith in Denton will give you a firm quote over the phone.
            </li>
            <li>
              <strong>Avoid national call centres</strong> â€” they often advertise low prices but add fees once
              the job is done. You want to speak directly to your locksmith, not a booking agent.
            </li>
            <li>
              <strong>Check they are insured</strong> â€” Car Keys Stockport is fully insured. Always ask for
              proof of insurance before allowing work to begin.
            </li>
            <li>
              <strong>Use a local Denton auto locksmith specialist</strong> â€” local means faster arrival,
              local knowledge of SK14, and no middleman markup.
            </li>
          </ul>
          <p className="leading-relaxed">
            Car Keys Stockport ticks every box. We are a genuine local, cheap, 24 hour locksmith in Denton â€”
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-4">
            ...
            then relay your details to a subcontractor â€” and your &quot;cheap locksmith Denton&quot; quote
            suddenly grows.
          </p>
          <p className="leading-relaxed mb-4">
            ...
            a genuine 20 minute response time â€” not an estimate.
          </p>
          <p className="leading-relaxed">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-4">
            ...
            locksmith help in the middle of the night â€” we are on call right now.
          </p>
          ...
          <p className="text-lg font-semibold">
            ...
            â€” we&apos;re ready to help right now, 24 hours a day.
          </p>
        </section>
