...
const location = "Heaton Mersey"
const locationSlug = "heaton-mersey"
const neighborhoods = ["Heaton Mersey","Heaton Moor","Heaton Chapel","Didsbury"]

export const metadata: Metadata = {
  title: "Heaton Mersey Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Heaton Mersey? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Heaton Mersey auto locksmith",
    "auto locksmith near me Heaton Mersey",
    "emergency locksmith Heaton Mersey",
    "car key replacement Heaton Mersey",
    "key fob programming Heaton Mersey",
    "lost car keys Heaton Mersey",
    "24/7 auto locksmith Heaton Mersey",
    "mobile locksmith Heaton Mersey",
    "emergency car lockout Heaton Mersey",
    "smart key programming Heaton Mersey",
  ],
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                  ...
                  you wherever you are in {location}ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Âhome, work, or roadside. Your trusted local auto locksmith service.
                </p>
