...
export const metadata: Metadata = {
  title: "Auto Locksmith Rochdale | Car Key Replacement & Emergency Service 24/7",
  description:
  ...
  keywords: "auto locksmith Rochdale, car locksmith Rochdale, lockout service, key replacement",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Auto Locksmith Rochdale | Professional Car Key & Emergency Service",
    description: "Fast auto locksmith services in Rochdale. Car key replacement, emergency lockout, key fob programming. 24/7 service. Call 07309903243",
    url: "https://carkeysinstockport.co.uk/areas/stockport/rochdale",
    type: "website",
  },
  alternates: {
    canonical: "https://carkeysinstockport.co.uk/areas/stockport/rochdale",
  },
}
...
const serviceAreas = ["Rochdale Town Centre", "Middleton", "Littleborough", "Milnrow", "Heywood"]
          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Fast, reliable locksmith services for {locationName} residents and businesses. Available 24/7 with 25-minute response time.
              </p>
              ...
              <article className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 text-lg">
                    {locationName}'s trusted auto locksmith service. Specializing in car key replacement, emergency lockout assistance, and key fob programming. Available 24/7 for urgent situations. Our mobile locksmiths bring the solution directly to you with no call-out fee.
                  </p>
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 mt-4">
                      Local knowledge of {locationName} and fast response times. Professional, fully insured technicians. Same-day service available for emergencies.
                    </p>
                  </section>
                </div>
              </article>
