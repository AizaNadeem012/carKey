...
const locationName = "Salford"
const locationSlug = "salford"

export const metadata: Metadata = {
  title: "Auto Locksmith Salford | Car Key Replacement & Emergency Lockout 24/7",
  description:
  ...
  keywords: "auto locksmith Salford, car locksmith Salford, lockout service, key replacement",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Auto Locksmith Salford | Professional Car Key & Emergency Service",
    description: "Fast auto locksmith services in Salford. Car key replacement, emergency lockout, key fob programming. 24/7 service. Call 07309903243",
    url: "https://carkeysinstockport.co.uk/areas/stockport/salford",
    type: "website",
  },
  alternates: {
    canonical: "https://carkeysinstockport.co.uk/areas/stockport/salford",
  },
}
...
const serviceAreas = ["Salford City Centre", "Eccles", "Worsley", "Irlam", "Pendlebury"]
          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Comprehensive auto locksmith services for {locationName} and surrounding areas. Available 24/7 with 25-minute response time.
              </p>
              ...
              <article className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 text-lg">
                    {locationName}'s auto locksmith service for all your automotive key and lockout needs. Our mobile locksmiths specialize in car key replacement, emergency lockout solutions, and professional key coding. Available around the clock for urgent locksmith emergencies.
                  </p>
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 mt-4">
                      Based locally in Greater Manchester, we understand {locationName} well. Fast response, professional service, fully insured.
                    </p>
                  </section>
                </div>
              </article>
