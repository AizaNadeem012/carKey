...
const locationName = "Oldham"
const locationSlug = "oldham"

export const metadata: Metadata = {
  title: "Auto Locksmith Oldham | Car Key & Van Locksmith Emergency Service 24/7",
  description:
  ...
  keywords: "auto locksmith Oldham, car locksmith Oldham, lockout service, key replacement",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Auto Locksmith Oldham | Professional Car Key & Emergency Service",
    description: "Fast auto locksmith services in Oldham. Car key replacement, emergency lockout, key fob programming. 24/7 service. Call 07309903243",
    url: "https://carkeysinstockport.co.uk/areas/stockport/oldham",
    type: "website",
  },
  alternates: {
    canonical: "https://carkeysinstockport.co.uk/areas/stockport/oldham",
  },
}
...
const serviceAreas = ["Oldham Town Centre", "Chadderton", "Failsworth", "Lees", "Royton"]
          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Trusted auto locksmith services in {locationName}, offering comprehensive solutions for car and van lockouts. Available 24/7 with 25-minute response time.
              </p>
              ...
              <article className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 text-lg">
                    {locationName}'s trusted auto locksmith service for all your car and van locksmith needs. Our experienced technicians are equipped to handle all makes and models with professional, non-destructive techniques. From emergency lockouts to key replacement and programming, we provide fast, reliable service.
                  </p>
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 mt-4">
                      We understand {locationName}'s busy streets and can reach you quickly. Professional, certified locksmiths with modern equipment. Transparent pricing with no surprises.
                    </p>
                  </section>
                </div>
              </article>
