...
const locationName = "Tameside"
const locationSlug = "tameside"

export const metadata: Metadata = {
  title: "Auto Locksmith Tameside | Car Key & Emergency Lockout Service 24/7",
  description:
  ...
  keywords: "auto locksmith Tameside, car locksmith Tameside, lockout service, key replacement",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Auto Locksmith Tameside | Professional Car Key & Emergency Service",
    description: "Fast auto locksmith services in Tameside. Car key replacement, emergency lockout, key fob programming. 24/7 service. Call 07309903243",
    url: "https://carkeysinstockport.co.uk/areas/stockport/tameside",
    type: "website",
  },
  alternates: {
    canonical: "https://carkeysinstockport.co.uk/areas/stockport/tameside",
  },
}
...
const serviceAreas = ["Ashton-under-Lyne", "Denton", "Dukinfield", "Mossley", "Stalybridge"]
          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Professional auto locksmith services across {locationName}, including Ashton-under-Lyne and Denton. Available 24/7 with 25-minute response time.
              </p>
              ...
              <article className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 text-lg">
                    {locationName}'s professional auto locksmith service. Whether you need emergency car lockout help or car key replacement, our mobile locksmiths provide fast, professional service with transparent pricing. We handle all vehicle types and security systems.
                  </p>
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 mt-4">
                      Serving {locationName} with fast response times and professional service. Fully insured and certified technicians available 24/7.
                    </p>
                  </section>
                </div>
              </article>
