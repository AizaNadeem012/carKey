...
export const alt =
  "Vikki Heaton ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Female Auto Locksmith Stockport | Car Keys Stockport"
...
export default function OGImage() {
  return new ImageResponse(
    (
      ...
      >
        {/* Left panel ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â photo placeholder with gradient overlay */}
        <div
          style={{
            display: "flex",
            width: 600,
        ...
        {/* Right panel ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â branding */}
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          >
            {[
              ...
              { value: "5ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦", label: "Rated" },
            ].map(({ value, label }, i) => (
              <div
                key={i}
                style={{
          ...
          >
            ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¾ 07309 903243
          </div>
