...
const location = "Marple"
const locationSlug = "marple"
const neighborhoods = ["Marple","Marple Bridge","Compstall","High Lane"]

export const metadata: Metadata = {
  title: "Marple Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Looking for an auto locksmith near me in Marple? Our certified mobile locksmiths provide 24/7 emergency car lockout assistance, lost key replacement, key fob programming, and ignition repair. Call 07309903243 now.",
  keywords: [
    "Marple auto locksmith",
    "auto locksmith near me Marple",
    "emergency locksmith Marple",
    "car key replacement Marple",
    "key fob programming Marple",
    "lost car keys Marple",
    "24/7 auto locksmith Marple",
    "mobile locksmith Marple",
    "emergency car lockout Marple",
    "smart key programming Marple",
  ],
