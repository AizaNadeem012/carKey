...
export const metadata: Metadata = {
  ...
  title: {
    default: "Car Keys Stockport | Vikki Heaton Auto Locksmith",
    template: "%s | Car Keys Stockport",
  },
  description:
    "Vikki Heaton â€” trusted female auto locksmith in Stockport. Car key replacement, van lockout & emergency locksmith services 24/7. No call-out fee. Call 07309903243.",
  keywords: [
    "car key replacement",
    "Stockport",
    "auto locksmith",
  ...
  openGraph: {
    ...
    siteName: "Car Keys Stockport",
    title: "Car Keys Stockport | Vikki Heaton Auto Locksmith",
    description:
      "Female-owned auto locksmith in Stockport. Car key replacement, van lockout & 24/7 emergency service. No call-out fee.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Vikki Heaton â€” Female Auto Locksmith Stockport | Car Keys Stockport",
      },
    ],
  },
  twitter: {
    ...
    title: "Car Keys Stockport | Vikki Heaton Auto Locksmith",
    description:
      "Female-owned auto locksmith in Stockport. 24/7 car key replacement & lockout service.",
    images: ["/og-image.jpg"],
  },
  verification: {
  ...
  return (
    <html lang="en-GB">
      <head>
        ...
        {/* Brand colour in browser chrome â€” mobile Safari/Chrome address bar */}
        ...
        {/* Safari pinned tab â€” uses SVG + brand colour */}
        <link rel="mask-icon" href="/favicon.svg" color="#f97316" />

        {/* Preload hero image â€” critical for LCP score */}
        <link
          rel="preload"
          as="image"
          href="/images/vikki-heaton-auto-locksmith-stockport.jpg"
          fetchPriority="high"
        />
      </head>
      <body className={inter.className} suppressHydrationWarning>
        {/* GA4 SPA page-view tracker â€” fires on every client-side route change */}
        <PageViewTracker />
            ...
            <div className="flex items-center justify-between h-16 gap-4">
              <Link href="/" className="flex items-center gap-3">
                <Image
                  ...
                  alt="Vikki Heaton â€” Auto Locksmith Stockport"
                  title="Car Keys Stockport | Vikki Heaton Auto Locksmith"
                  width={44}
                  height={44}
                  priority={true}
        ...
        {/* Footer */}
        <footer className="bg-slate-900 border-t border-slate-700 pb-20 md:pb-0">
          <div className="container-custom py-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-gray-400 mb-2">
                  ...
                  <span className="text-xs sm:text-sm">Stockport, Greater Manchester</span>
                </div>
            ...
            {/* Verified Author Block â€” E-E-A-T signal */}
            <div className="border-t border-slate-700 mt-8 pt-8 mb-6 flex flex-col sm:flex-row items-center sm:items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs mb-1">Auto Locksmith &amp; Business Owner â€” Car Keys Stockport</p>
                <p className="text-gray-400 text-xs leading-relaxed max-w-xl">
                  Vikki is a fully insured, female auto locksmith based in Stockport, serving customers across Greater Manchester since 2016. She personally handles every job â€” no subcontractors.
                </p>
                <a
                  href="https://www.facebook.com/vikki.heaton.5"
                  target="_blank"
                  rel="noopener noreferrer me"
                  className="text-orange-400 hover:text-orange-300 text-xs mt-1 inline-block transition-colors"
                >
                  Follow Vikki on Facebook
                </a>
              </div>
            </div>
            ...
            <div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
              <p className="text-gray-400 text-xs sm:text-sm">
                Â© {new Date().getFullYear()} Car Keys Stockport. All rights reserved.
              </p>
        ...
        />
        {/* Google Analytics 4 â€” loads after page is interactive, no render-blocking */}
        <Script
