...
const neighborhoods = ["Hazel Grove","Norbury","Offerton","Woodsmoor"]
const region = "Greater Manchester"

export const metadata: Metadata = {
  title: "Hazel Grove Auto Locksmith Near Me 24/7 | Fast Car Key & Lockout Services",
  description:
    "Professional auto locksmith near me in Hazel Grove. 24/7 mobile locksmith service for lost car key replacement, key fob programming, emergency car lockout assistance, and ignition repair. Fast response, fully insured, no call-out fee. Call 07309903243 now.",
  keywords: [
    "Hazel Grove auto locksmith",
    "auto locksmith near me Hazel Grove",
    "Hazel Grove car key replacement",
    "Hazel Grove emergency locksmith",
    "lost car keys Hazel Grove",
    "key fob programming Hazel Grove",
    "24/7 locksmith Hazel Grove",
    "mobile locksmith Hazel Grove",
    "emergency car lockout Hazel Grove",
    "smart key programming Hazel Grove",
    "transponder key Hazel Grove",
    "ignition repair Hazel Grove",
  ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Hazel Grove Auto Locksmith Near Me 24/7 | Fast Car Key Services",
    description:
      "Professional 24/7 auto locksmith in Hazel Grove. Lost car key replacement, emergency lockout assistance, key fob programming. Fast response. Call 07309903243",
    url: `https://carkeysinstockport.co.uk/${locationSlug}`,
    type: "website",
    siteName: "Auto Locksmith Hazel Grove",
    locale: "en_GB",
    images: [
      {
        url: "https://carkeysinstockport.co.uk/images/auto-locksmith-hazel-grove.jpg",
        width: 1200,
        height: 630,
        alt: "Professional auto locksmith service in Hazel Grove",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Hazel Grove Auto Locksmith Near Me 24/7",
    description: "Professional auto locksmith services in Hazel Grove. Fast response, fully insured. Call 07309903243",
    images: ["https://carkeysinstockport.co.uk/images/auto-locksmith-hazel-grove.jpg"],
  },
  alternates: {
...
const localBusinessSchema = {
  ...
  image: "https://carkeysinstockport.co.uk/images/auto-locksmith-hazel-grove.jpg",
